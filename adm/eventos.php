...
<main>
    <div class="flex items-center justify-between">
        ...
        <button class="btn-novo" onclick="abrirCadastrarModal('eventos')">
                ...
                <div class="card-eventos">
                    ...
                    <div class="container-opcoes">
                        ...
                        <button class="w-10 h-10 rounded-lg hover:bg-blue-100 text-blue-500 cursor-pointer"
                            onclick="abrirEditarModal('eventos', <?= htmlspecialchars($row['id']) ?>)">
                            <i class="bi bi-pencil"></i>
                        </button>
                        <!--deletar-->
                        <form action="deletar_eventos" method="POST">
                            <!--csrf-->
