    ...
    <form action="fazer_login" method="POST" class="flex w-full flex-col items-center justify-center space-y-6 rounded-xl bg-white px-[4%] py-6 shadow-xl/30 lg:w-auto lg:min-w-lg lg:px-6 lg:py-6">
        ...
        <div class="w-full">
            ...
            <div class="flex flex-col w-full relative">
                ...
                <input type="email" name="email" placeholder="Email" class="w-full rounded-lg border border-gray-300 bg-gray-200 py-3 pr-4 pl-10 outline-none focus:border-none focus:ring-2 focus:ring-blue-600" required>
            </div>
        </div>
        <div class="w-full">
            ...
            <div class="flex flex-col w-full relative">
                ...
                <input type="password" name="senha" placeholder="Senha" class="w-full rounded-lg border border-gray-300 bg-gray-200 py-3 pr-4 pl-10 outline-none focus:border-none focus:ring-2 focus:ring-blue-600" required>
            </div>
        </div>
        <button type="submit" class="w-full cursor-pointer rounded-lg bg-blue-600 py-3 font-medium text-white transition-colors hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">Login</button>
    </form>
</main>
